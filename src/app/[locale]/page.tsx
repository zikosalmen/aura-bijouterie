  ...
  return (
    <div ref={containerRef} className="relative h-[300vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-black">
        {/* ── Video ── */}
        <video ref={videoRef} src="/vd_scroll_finit.mp4" muted playsInline preload="auto" /* keeps the first decoded frame visible */ onLoadedData={(e) => { (e.target as HTMLVideoElement).currentTime = 0.001; }} className="absolute inset-0 h-full w-full object-cover" />
